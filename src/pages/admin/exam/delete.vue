            ...
            <el-page-header @back="onBack('/admin/exam/list')" class=" ml-3 mt-3 mb-3">
                <template #breadcrumb>
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>题目删除</el-breadcrumb-item>
                    </el-breadcrumb>
                </template>
                <template #content>
                    <span class="text-large font-600 mr-3"> 题目删除 </span>
                </template>
            </el-page-header>
...
import ExamDeleteAdmin from '~/components/admin/exam/ExamDeleteAdmin.vue'
