<template>
    <el-container class="layout-container-demo w-screen">
        <el-container>
            ...
            <!-- 页header -->
            <el-page-header @back="onBack('/admin/exam/list')" class=" ml-3 mt-3 mb-3">
                <template #breadcrumb>
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>题目编辑</el-breadcrumb-item>
                    </el-breadcrumb>
                </template>
                <template #content>
                    <span class="text-large font-600 mr-3"> 题目编辑 </span>
                </template>
            </el-page-header>
            ...
            <el-main>
                ...
                <ExamEditAdmin :id="id"></ExamEditAdmin>
...
import ExamEditAdmin from '~/components/admin/exam/ExamEditAdmin.vue'
